...
<form method="POST" action="admininsertProcess.php" class="form-horizontal">
...
?>
  ...
  <div class="form-group">
  <label>Value</label>  
  <input id="Value" name="model_value" type="number" min="10000.00" max="99999999.99" placeholder="Value in USD" class="form-control input-md" required>
  </div>
