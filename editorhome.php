      ...
      <div class="intro">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">Treasured Editors</span>
            <span class="section-heading-lower">Welcome!</span>
          </h2>
          <p class="mb-3">As an editor for Vroom Vehicle Discovery, you have access to exclusive add and udpate tools. These tools enable you to keep the collection growing, while ensuring utmost quality! To exit out of editor mode, click the button below, or click the 'Shopper' button in the header on any page. </p>
          <div class="intro-button mx-auto">
            <a class="btn btn-primary btn-xl" href="index.php">Exit Editor Mode</a>
          </div>
        </div>
      </div>
    </div>
