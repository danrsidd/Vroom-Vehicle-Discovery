      ...
      <div class="intro">
        ...
        <div class="intro-text left-0 text-center bg-faded p-5 rounded">
          <h2 class="section-heading mb-4">
            <span class="section-heading-upper">VVD Admin</span>
            <span class="section-heading-lower">Welcome!</span>
          </h2>
          <p class="mb-3">As an admin for Vroom Vehicle Discovery, you have access to exclusive add, udpate, and delete tools. These tools enable you to keep the collection under control to ensure utmost quality! To exit out of admin mode, click the button below, or click the 'Shopper' button in the header on any page. </p>
          <div class="intro-button mx-auto">
            <a class="btn btn-primary btn-xl" href="index.php">Exit Admin Mode</a>
          </div>
        </div>
      </div>
    </div>
