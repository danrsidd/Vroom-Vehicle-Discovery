...
<form method="POST" action="adminupdateProcess.php" class="form-horizontal">
 ...
 <?php
  ...
  if($result)
  {
    ...
    while($row=mysqli_fetch_assoc($result))
    {
      ...
      //Load data onto form field
      echo "<label>Model Value:</label><input type='number' min='10000.00' max='99999999.99' name='model_value' value='$model_value' class='form-control'/><br/><br/>";
    }
