     ...
     <section style="background: rgb(2,0,36); background: linear-gradient(90deg, rgba(2,0,36,1) 0%, rgba(255,226,145,0.8925945378151261) 0%);");>
      <div class="container">
        ...
        <br>
                ...
                <span class="section-heading-upper">(*Note:  An empty result table indicates no results for the desired search.)</span>         
        </h2>
...
<div class="row justify-content-center">
    ...
    if(!empty($feature_id)){
      ...
      for($i=0; $i<sizeof($feature_id); $i++){
        ...
        $sql = "SELECT mk.make_name, mdl.model_name, mdl.model_value, mdl.model_year, b.body_style
        ...
        WHERE (b.body_id = '$body_id') AND (mdl.model_year = '$model_year') AND (vf.feature_id = '$feature_id[$i]');";
